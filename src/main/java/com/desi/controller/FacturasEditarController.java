...
import com.desi.entity.MedioPago;
import com.desi.controller.FacturaForm;
import com.desi.service.FacturaService;
...
public class FacturasEditarController {
	...
	private void cargarAtributosFormulario(Model model) {
		model.addAttribute("contratos", contratoService.listarConFiltros(null, null, null, null)); // Trae los contratos de tu compañero
