...
import com.desi.entity.Factura;
import com.desi.entity.Contrato;
import com.desi.entity.EstadoContrato;
import com.desi.entity.EstadoFactura;
import com.desi.repository.ContratoRepository;
import com.desi.repository.FacturaRepository;
import com.desi.repository.HistorialEstadoFacturaRepository;
...
public class FacturaServiceImpl implements FacturaService {
	...
	public void update(Factura factura) throws Excepcion {
		...
		if (estadoAnterior != estadoNuevo) {
			historialRepository.save(new com.desi.entity.HistorialEstadoFactura(existente, estadoNuevo));
		}
	}
	...
	public void deleteById(Long id) {
		...
		if (factura.getEstado() == com.desi.entity.EstadoFactura.PAGADA) {
